...
| P2  | Горизонтальное масштабирование на два ЦОД               |              |
|     | ...                                                     |              |
...
| +R2 | Использовать технологии БД MS SQL и Oracle              |              |
...
| +R11 | Текущая платформа интернет-банка не совместима с Kafka |              |
| +R12 | Использовать платформы Java, .NET, PHP                 |              |
